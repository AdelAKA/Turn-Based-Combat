...
namespace DG.Tweening
{
	...
	public class DOTweenAnimation : ABSAnimationComponent
	{
		...
		{
			//            if (target == null) {
			//                Debug.LogWarning(string.Format("{0} :: This DOTweenAnimation's target is NULL, because the animation was created with a DOTween Pro version older than 0.9.255. To fix this, exit Play mode then simply select this object, and it will update automatically", this._game.name), this._game);
			//                return;
			//            }
		...
		/// UpdateValues it to TRUE when spawning the same DOTweenAnimation in different positions (like when using a pooling system)</param>
		...
		{
			//            return DOTween.TweensByTarget(this._game);
		...
		// Returns the _game whose target component should be animated
	...
	public static class DOTweenAnimationExtensions
	{
		...
		//        public static bool IsSameOrSubclassOf(this LocalizationToken t, LocalizationToken tBase)
		//        {
