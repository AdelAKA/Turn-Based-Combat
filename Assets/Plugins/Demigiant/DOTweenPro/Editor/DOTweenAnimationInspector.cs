...
#pragma warning restore 414
		...
		override public void OnInspectorGUI()
		{
			...
			else
			{
				...
				{
					// UpdateValues default optional values based on animation type
				...
				_src.loops = EditorGUILayout.IntField(new GUIContent("Loops", "UpdateValues to -1 for infinite loops"), _src.loops);
				if (_src.loops < -1) _src.loops = -1;
				if (_src.loops > 1 || _src.loops == -1)
					_src.loopType = (LoopType)EditorGUILayout.EnumPopup("   Loop LocalizationToken", _src.loopType);
